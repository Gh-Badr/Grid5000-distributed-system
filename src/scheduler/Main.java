...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        Node n8 = new Node("T8", List.of("CommandO", "CommandY","CommandZ"));

        Map<Node, List<Node>> dependencies = new HashMap<>();
        dependencies.put(n1, List.of(n2, n3,n8)); // n1 -> n2, n3,n8
        dependencies.put(n2, List.of(n4)); // n2 -> n4
        dependencies.put(n3, List.of(n2,n4)); // n3 -> n2, n4
        dependencies.put(n4, List.of(n5,n6)); // n4 -> n5, n6
        dependencies.put(n5, List.of(n8,n7)); // n5 -> n8
        dependencies.put(n6, new ArrayList<>()); // n6 -> depends on nothing
        dependencies.put(n7, new ArrayList<>()); // n7 depends on nothing
        dependencies.put(n8, new ArrayList<>()); // n8 depends on nothing
